...
def download_file(filename):
    try:
        ...
        size_str = ClientSecurity.decrypt(header_data, shift).decode().strip()
        ...
        if size_str.isnumeric():
            ...
            encrypted_data = FileHandle.recv_exact(client, total_size)


            decrypted_data = ClientSecurity.decrypt(encrypted_data, shift)
